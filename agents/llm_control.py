...
import pandas as pd
import json
os.environ["OPENAI_API_KEY"] = "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"
...
class llmagent:
    def __init__(self):
        self.api_key = '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'  # Replace with your OpenAI API key
    ...
    def generate_decision(self, state):
        description = '''
        {
            ...
            'change right': whether or not able to change right(true is able, false is not able ),
            'change left': whether or not able to change left(true is able, false is not able )
            }
        }
        '''
        input_=f"""
        ...
        Based on the traffic rule, the minimum safe distance to leader vehicle is 3m.\
